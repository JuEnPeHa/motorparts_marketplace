...
class PageViewOrderSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final PaymentMethodViewable paymentMethod = PaymentMethodViewable(
      paymentMethod: 'Visa',
